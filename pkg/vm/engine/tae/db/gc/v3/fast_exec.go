...
func (e *FastBasedGCJob) Close() error {
	if e.sourcer != nil {
		e.sourcer.Close()
		e.sourcer = nil
	}
...
func (e *FastBasedGCJob) fillDefaults() {
	if e.config.canGCCacheSize <= 0 {
		e.config.canGCCacheSize = Default_CanGC_TailSize
	}
}

func (e *FastBasedGCJob) Execute(ctx context.Context) error {
...
func (e *FastBasedGCJob) Result() ([]string, []objectio.ObjectStats) {
