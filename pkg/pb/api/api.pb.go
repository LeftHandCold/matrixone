...
const (
	...
	AlterKind_UpdateAutoIncrement AlterKind = 10
)
...
type LifecycleCommitEntry_RetireMode int32

const (
	LifecycleCommitEntry_Whole   LifecycleCommitEntry_RetireMode = 0
	LifecycleCommitEntry_Rewrite LifecycleCommitEntry_RetireMode = 1
)

var LifecycleCommitEntry_RetireMode_name = map[int32]string{
	0: "Whole",
	1: "Rewrite",
}

var LifecycleCommitEntry_RetireMode_value = map[string]int32{
	"Whole":   0,
	"Rewrite": 1,
}

func (x LifecycleCommitEntry_RetireMode) String() string {
	return proto.EnumName(LifecycleCommitEntry_RetireMode_name, int32(x))
}

func (LifecycleCommitEntry_RetireMode) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	Entry_LifecycleCommit Entry_EntryType = 7
)
...
func (m *PrecommitWriteCmd) GetSyncProtectionJobId() string {
	if m != nil {
		return m.SyncProtectionJobId
	}
	return ""
}

type LifecycleCommitEntry struct {
	ProtocolVersion              uint32                          `protobuf:"varint,1,opt,name=protocol_version,json=protocolVersion,proto3" json:"protocol_version,omitempty"`
	RetireMode                   LifecycleCommitEntry_RetireMode `protobuf:"varint,2,opt,name=retire_mode,json=retireMode,proto3,enum=api.LifecycleCommitEntry_RetireMode" json:"retire_mode,omitempty"`
	...
	DatabaseId                   uint64                          `protobuf:"varint,7,opt,name=database_id,json=databaseId,proto3" json:"database_id,omitempty"`
	LogicalTableId               uint64                          `protobuf:"varint,8,opt,name=logical_table_id,json=logicalTableId,proto3" json:"logical_table_id,omitempty"`
	PhysicalTableId              uint64                          `protobuf:"varint,9,opt,name=physical_table_id,json=physicalTableId,proto3" json:"physical_table_id,omitempty"`
	BindingGeneration            uint64                          `protobuf:"varint,10,opt,name=binding_generation,json=bindingGeneration,proto3" json:"binding_generation,omitempty"`
	SchemaDigest                 []byte                          `protobuf:"bytes,11,opt,name=schema_digest,json=schemaDigest,proto3" json:"schema_digest,omitempty"`
	SourceSnapshotTs             *timestamp.Timestamp            `protobuf:"bytes,12,opt,name=source_snapshot_ts,json=sourceSnapshotTs,proto3" json:"source_snapshot_ts,omitempty"`
	SourceSetDigest              []byte                          `protobuf:"bytes,13,opt,name=source_set_digest,json=sourceSetDigest,proto3" json:"source_set_digest,omitempty"`
	DataSourceObjectStats        [][]byte                        `protobuf:"bytes,14,rep,name=data_source_object_stats,json=dataSourceObjectStats,proto3" json:"data_source_object_stats,omitempty"`
	CreatedObjectStats           [][]byte                        `protobuf:"bytes,15,rep,name=created_object_stats,json=createdObjectStats,proto3" json:"created_object_stats,omitempty"`
	TransferBookingLocations     []string                        `protobuf:"bytes,16,rep,name=transfer_booking_locations,json=transferBookingLocations,proto3" json:"transfer_booking_locations,omitempty"`
	TransferMappingDigest        []byte                          `protobuf:"bytes,17,opt,name=transfer_mapping_digest,json=transferMappingDigest,proto3" json:"transfer_mapping_digest,omitempty"`
	FinalPrepareDeadlineUnixNano int64                           `protobuf:"varint,18,opt,name=final_prepare_deadline_unix_nano,json=finalPrepareDeadlineUnixNano,proto3" json:"final_prepare_deadline_unix_nano,omitempty"`
	MaxDeltaRows                 uint64                          `protobuf:"varint,19,opt,name=max_delta_rows,json=maxDeltaRows,proto3" json:"max_delta_rows,omitempty"`
	MaxDeltaBytes                uint64                          `protobuf:"varint,20,opt,name=max_delta_bytes,json=maxDeltaBytes,proto3" json:"max_delta_bytes,omitempty"`
	MaxDeltaBlocks               uint32                          `protobuf:"varint,21,opt,name=max_delta_blocks,json=maxDeltaBlocks,proto3" json:"max_delta_blocks,omitempty"`
	MergeLevel                   int32                           `protobuf:"varint,22,opt,name=merge_level,json=mergeLevel,proto3" json:"merge_level,omitempty"`
	XXX_NoUnkeyedLiteral         struct{}                        `json:"-"`
	XXX_unrecognized             []byte                          `json:"-"`
	XXX_sizecache                int32                           `json:"-"`
}

func (m *LifecycleCommitEntry) Reset()         { *m = LifecycleCommitEntry{} }
func (m *LifecycleCommitEntry) String() string { return proto.CompactTextString(m) }
func (*LifecycleCommitEntry) ProtoMessage()    {}
func (*LifecycleCommitEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_00212fb1f9d3bf1c, []int{9}
}
func (m *LifecycleCommitEntry) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *LifecycleCommitEntry) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_LifecycleCommitEntry.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *LifecycleCommitEntry) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LifecycleCommitEntry.Merge(m, src)
}
func (m *LifecycleCommitEntry) XXX_Size() int {
	return m.ProtoSize()
}
func (m *LifecycleCommitEntry) XXX_DiscardUnknown() {
	xxx_messageInfo_LifecycleCommitEntry.DiscardUnknown(m)
}

var xxx_messageInfo_LifecycleCommitEntry proto.InternalMessageInfo

func (m *LifecycleCommitEntry) GetProtocolVersion() uint32 {
	if m != nil {
...
func (m *LifecycleCommitEntry) GetRetireMode() LifecycleCommitEntry_RetireMode {
	if m != nil {
		return m.RetireMode
	}
	return LifecycleCommitEntry_Whole
}

func (m *LifecycleCommitEntry) GetRootId() string {
	if m != nil {
		return m.RootId
	}
	return ""
...
func (m *LifecycleCommitEntry) GetAttemptId() string {
	if m != nil {
		return m.AttemptId
	}
	return ""
...
func (m *LifecycleCommitEntry) GetDatasetId() string {
	if m != nil {
		return m.DatasetId
	}
	return ""
...
func (m *LifecycleCommitEntry) GetReceiptId() string {
	if m != nil {
		return m.ReceiptId
	}
	return ""
...
func (m *LifecycleCommitEntry) GetDatabaseId() uint64 {
	if m != nil {
		return m.DatabaseId
	}
	return 0
...
func (m *LifecycleCommitEntry) GetLogicalTableId() uint64 {
	if m != nil {
...
func (m *LifecycleCommitEntry) GetPhysicalTableId() uint64 {
	if m != nil {
...
func (m *LifecycleCommitEntry) GetBindingGeneration() uint64 {
	if m != nil {
		return m.BindingGeneration
	}
	return 0
}

func (m *LifecycleCommitEntry) GetSchemaDigest() []byte {
	if m != nil {
...
func (m *LifecycleCommitEntry) GetSourceSnapshotTs() *timestamp.Timestamp {
	if m != nil {
		return m.SourceSnapshotTs
	}
	return nil
}

func (m *LifecycleCommitEntry) GetSourceSetDigest() []byte {
	if m != nil {
		return m.SourceSetDigest
	}
	return nil
}

func (m *LifecycleCommitEntry) GetDataSourceObjectStats() [][]byte {
	if m != nil {
		return m.DataSourceObjectStats
	}
	return nil
}

func (m *LifecycleCommitEntry) GetCreatedObjectStats() [][]byte {
	if m != nil {
		return m.CreatedObjectStats
	}
	return nil
}

func (m *LifecycleCommitEntry) GetTransferBookingLocations() []string {
	if m != nil {
		return m.TransferBookingLocations
	}
	return nil
}

func (m *LifecycleCommitEntry) GetTransferMappingDigest() []byte {
	if m != nil {
		return m.TransferMappingDigest
	}
	return nil
}

func (m *LifecycleCommitEntry) GetFinalPrepareDeadlineUnixNano() int64 {
	if m != nil {
		return m.FinalPrepareDeadlineUnixNano
	}
	return 0
}

func (m *LifecycleCommitEntry) GetMaxDeltaRows() uint64 {
	if m != nil {
		return m.MaxDeltaRows
	}
	return 0
}

func (m *LifecycleCommitEntry) GetMaxDeltaBytes() uint64 {
	if m != nil {
		return m.MaxDeltaBytes
	}
	return 0
}

func (m *LifecycleCommitEntry) GetMaxDeltaBlocks() uint32 {
	if m != nil {
		return m.MaxDeltaBlocks
	}
	return 0
}

func (m *LifecycleCommitEntry) GetMergeLevel() int32 {
	if m != nil {
		return m.MergeLevel
	}
	return 0
...
type Entry struct {
	...
	// AUTO_INCREMENT epoch used by the CN when planning this write.
	// Consult auto_incr_epoch_known because zero is a valid initial epoch.
	AutoIncrEpoch uint32 `protobuf:"varint,9,opt,name=auto_incr_epoch,json=autoIncrEpoch,proto3" json:"auto_incr_epoch,omitempty"`
	// whether auto_incr_epoch was supplied by an epoch-aware CN.
	AutoIncrEpochKnown   bool                  `protobuf:"varint,10,opt,name=auto_incr_epoch_known,json=autoIncrEpochKnown,proto3" json:"auto_incr_epoch_known,omitempty"`
	LifecycleCommit      *LifecycleCommitEntry `protobuf:"bytes,11,opt,name=lifecycle_commit,json=lifecycleCommit,proto3" json:"lifecycle_commit,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (m *Entry) GetAutoIncrEpochKnown() bool {
	if m != nil {
		return m.AutoIncrEpochKnown
	}
	return false
}

func (m *Entry) GetLifecycleCommit() *LifecycleCommitEntry {
	if m != nil {
		return m.LifecycleCommit
	}
	return nil
}
...
func (m *AlterTableReplaceDef) Reset()         { *m = AlterTableReplaceDef{} }
func (m *AlterTableReplaceDef) String() string { return proto.CompactTextString(m) }
...
func (m *AlterTableReplaceDef) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AlterTableReplaceDef.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AlterTableReplaceDef) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AlterTableReplaceDef.Merge(m, src)
}
func (m *AlterTableReplaceDef) XXX_Size() int {
	return m.ProtoSize()
}
func (m *AlterTableReplaceDef) XXX_DiscardUnknown() {
	xxx_messageInfo_AlterTableReplaceDef.DiscardUnknown(m)
}

var xxx_messageInfo_AlterTableReplaceDef proto.InternalMessageInfo
...
func (m *AlterTableAutoIncrement) GetOffset() uint64 {
	if m != nil {
		return m.Offset
	}
	return 0
...
func (m *AlterTableAutoIncrement) GetEpoch() uint32 {
	if m != nil {
		return m.Epoch
	}
	return 0
...
type AlterTableReq struct {
	...
	//	*AlterTableReq_UpdateAutoIncrement
...
type AlterTableReq_UpdateAutoIncrement struct {
	UpdateAutoIncrement *AlterTableAutoIncrement `protobuf:"bytes,13,opt,name=update_auto_increment,json=updateAutoIncrement,proto3,oneof" json:"update_auto_increment,omitempty"`
}
...
func (*AlterTableReq_ReplaceDef) isAlterTableReq_Operation()          {}
func (*AlterTableReq_UpdateAutoIncrement) isAlterTableReq_Operation() {}
...
func (m *AlterTableReq) GetReplaceDef() *AlterTableReplaceDef {
	if x, ok := m.GetOperation().(*AlterTableReq_ReplaceDef); ok {
		return x.ReplaceDef
	}
	return nil
}

func (m *AlterTableReq) GetUpdateAutoIncrement() *AlterTableAutoIncrement {
	if x, ok := m.GetOperation().(*AlterTableReq_UpdateAutoIncrement); ok {
		return x.UpdateAutoIncrement
	}
	return nil
}
...
func (*AlterTableReq) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*AlterTableReq_ReplaceDef)(nil),
		(*AlterTableReq_UpdateAutoIncrement)(nil),
	}
}
...
type SchemaExtra struct {
	...
	AutoIncrOffset  uint64 `protobuf:"varint,16,opt,name=auto_incr_offset,json=autoIncrOffset,proto3" json:"auto_incr_offset,omitempty"`
	// Advances only when AUTO_INCREMENT allocation is reset.
	AutoIncrEpoch        uint32   `protobuf:"varint,17,opt,name=auto_incr_epoch,json=autoIncrEpoch,proto3" json:"auto_incr_epoch,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *SchemaExtra) GetFromPublication() bool {
	if m != nil {
		return m.FromPublication
	}
	return false
}

func (m *SchemaExtra) GetAutoIncrOffset() uint64 {
	if m != nil {
...
func init() {
	...
	proto.RegisterEnum("api.LifecycleCommitEntry_RetireMode", LifecycleCommitEntry_RetireMode_name, LifecycleCommitEntry_RetireMode_value)
	...
	proto.RegisterType((*LifecycleCommitEntry)(nil), "api.LifecycleCommitEntry")
	...
	proto.RegisterType((*AlterTableReplaceDef)(nil), "api.AlterTableReplaceDef")
	proto.RegisterType((*AlterTableDropColumn)(nil), "api.AlterTableDropColumn")
	proto.RegisterType((*AlterTableAutoIncrement)(nil), "api.AlterTableAutoIncrement")
...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	,
}
...
func (m *PrecommitWriteCmd) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SyncProtectionJobId) > 0 {
		i -= len(m.SyncProtectionJobId)
		copy(dAtA[i:], m.SyncProtectionJobId)
		i = encodeVarintApi(dAtA, i, uint64(len(m.SyncProtectionJobId)))
		i--
		dAtA[i] = 0x12
	}
...
func (m *LifecycleCommitEntry) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *LifecycleCommitEntry) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LifecycleCommitEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.MergeLevel != 0 {
		i = encodeVarintApi(dAtA, i, uint64(m.MergeLevel))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb0
	}
	if m.MaxDeltaBlocks != 0 {
		i = encodeVarintApi(dAtA, i, uint64(m.MaxDeltaBlocks))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa8
	}
	if m.MaxDeltaBytes != 0 {
		i = encodeVarintApi(dAtA, i, uint64(m.MaxDeltaBytes))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa0
	...
	if m.MaxDeltaRows != 0 {
		i = encodeVarintApi(dAtA, i, uint64(m.MaxDeltaRows))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x98
	}
	if m.FinalPrepareDeadlineUnixNano != 0 {
		i = encodeVarintApi(dAtA, i, uint64(m.FinalPrepareDeadlineUnixNano))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x90
	}
	if len(m.TransferMappingDigest) > 0 {
		i -= len(m.TransferMappingDigest)
		copy(dAtA[i:], m.TransferMappingDigest)
		i = encodeVarintApi(dAtA, i, uint64(len(m.TransferMappingDigest)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x8a
	}
	if len(m.TransferBookingLocations) > 0 {
		for iNdEx := len(m.TransferBookingLocations) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.TransferBookingLocations[iNdEx])
			copy(dAtA[i:], m.TransferBookingLocations[iNdEx])
			i = encodeVarintApi(dAtA, i, uint64(len(m.TransferBookingLocations[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0x82
	...
	if len(m.CreatedObjectStats) > 0 {
		for iNdEx := len(m.CreatedObjectStats) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.CreatedObjectStats[iNdEx])
			copy(dAtA[i:], m.CreatedObjectStats[iNdEx])
			i = encodeVarintApi(dAtA, i, uint64(len(m.CreatedObjectStats[iNdEx])))
			i--
			dAtA[i] = 0x7a
		}
	}
	if len(m.DataSourceObjectStats) > 0 {
		for iNdEx := len(m.DataSourceObjectStats) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.DataSourceObjectStats[iNdEx])
			copy(dAtA[i:], m.DataSourceObjectStats[iNdEx])
			i = encodeVarintApi(dAtA, i, uint64(len(m.DataSourceObjectStats[iNdEx])))
			i--
			dAtA[i] = 0x72
		}
	}
	if len(m.SourceSetDigest) > 0 {
		i -= len(m.SourceSetDigest)
		copy(dAtA[i:], m.SourceSetDigest)
		i = encodeVarintApi(dAtA, i, uint64(len(m.SourceSetDigest)))
		i--
		dAtA[i] = 0x6a
	}
	if m.SourceSnapshotTs != nil {
		{
			size, err := m.SourceSnapshotTs.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if len(m.SchemaDigest) > 0 {
		i -= len(m.SchemaDigest)
		copy(dAtA[i:], m.SchemaDigest)
		i = encodeVarintApi(dAtA, i, uint64(len(m.SchemaDigest)))
		i--
		dAtA[i] = 0x5a
	}
	if m.BindingGeneration != 0 {
		i = encodeVarintApi(dAtA, i, uint64(m.BindingGeneration))
		i--
		dAtA[i] = 0x50
	}
	if m.PhysicalTableId != 0 {
		i = encodeVarintApi(dAtA, i, uint64(m.PhysicalTableId))
		i--
		dAtA[i] = 0x48
	}
	if m.LogicalTableId != 0 {
		i = encodeVarintApi(dAtA, i, uint64(m.LogicalTableId))
		i--
		dAtA[i] = 0x40
	}
	if m.DatabaseId != 0 {
	...
	if len(m.ReceiptId) > 0 {
		...
		i = encodeVarintApi(dAtA, i, uint64(len(m.ReceiptId)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.DatasetId) > 0 {
		...
		i = encodeVarintApi(dAtA, i, uint64(len(m.DatasetId)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.AttemptId) > 0 {
		...
		i = encodeVarintApi(dAtA, i, uint64(len(m.AttemptId)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.RootId) > 0 {
	...
	if m.RetireMode != 0 {
		i = encodeVarintApi(dAtA, i, uint64(m.RetireMode))
		i--
		dAtA[i] = 0x10
	}
	if m.ProtocolVersion != 0 {
		i = encodeVarintApi(dAtA, i, uint64(m.ProtocolVersion))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Entry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LifecycleCommit != nil {
		{
			size, err := m.LifecycleCommit.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.AutoIncrEpoch != 0 {
		i = encodeVarintApi(dAtA, i, uint64(m.AutoIncrEpoch))
		i--
		dAtA[i] = 0x48
	}
	if m.PkCheckByTn != 0 {
...
func (m *AlterTablePolicy) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Hints) > 0 {
		dAtA18 := make([]byte, len(m.Hints)*10)
		var j17 int
...
func (m *AlterTableReq_ReplaceDef) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ReplaceDef != nil {
		{
			size, err := m.ReplaceDef.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *AlterTableReq_UpdateAutoIncrement) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AlterTableReq_UpdateAutoIncrement) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.UpdateAutoIncrement != nil {
		{
			size, err := m.UpdateAutoIncrement.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *SchemaExtra) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.AutoIncrOffset != 0 {
		i = encodeVarintApi(dAtA, i, uint64(m.AutoIncrOffset))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x80
	}
	if m.FromPublication {
		i--
		if m.FromPublication {
			dAtA[i] = 1
		} else {
	...
	if m.ParentTableID != 0 {
		i = encodeVarintApi(dAtA, i, uint64(m.ParentTableID))
		i--
		dAtA[i] = 0x70
	}
	if len(m.IndexTables) > 0 {
		dAtA31 := make([]byte, len(m.IndexTables)*10)
		var j30 int
		for _, num := range m.IndexTables {
			for num >= 1<<7 {
	...
	if m.FeatureFlag != 0 {
		i = encodeVarintApi(dAtA, i, uint64(m.FeatureFlag))
		i--
		dAtA[i] = 0x60
	}
	...
	if len(m.Hints) > 0 {
		dAtA33 := make([]byte, len(m.Hints)*10)
		var j32 int
		for _, num := range m.Hints {
			for num >= 1<<7 {
		...
		i = encodeVarintApi(dAtA, i, uint64(j32))
		i--
		dAtA[i] = 0x42
	}
	if m.MaxOsizeMergedObj != 0 {
...
func (m *LifecycleCommitEntry) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.ProtocolVersion != 0 {
		n += 1 + sovApi(uint64(m.ProtocolVersion))
	}
	if m.RetireMode != 0 {
		n += 1 + sovApi(uint64(m.RetireMode))
	}
	l = len(m.RootId)
	if l > 0 {
		n += 1 + l + sovApi(uint64(l))
	...
	if m.LogicalTableId != 0 {
		n += 1 + sovApi(uint64(m.LogicalTableId))
	}
	if m.PhysicalTableId != 0 {
		n += 1 + sovApi(uint64(m.PhysicalTableId))
	}
	if m.BindingGeneration != 0 {
		n += 1 + sovApi(uint64(m.BindingGeneration))
	}
	l = len(m.SchemaDigest)
	if l > 0 {
		n += 1 + l + sovApi(uint64(l))
	}
	if m.SourceSnapshotTs != nil {
		l = m.SourceSnapshotTs.ProtoSize()
		n += 1 + l + sovApi(uint64(l))
	}
	l = len(m.SourceSetDigest)
	if l > 0 {
		n += 1 + l + sovApi(uint64(l))
	}
	if len(m.DataSourceObjectStats) > 0 {
		for _, b := range m.DataSourceObjectStats {
			l = len(b)
			n += 1 + l + sovApi(uint64(l))
		}
	}
	if len(m.CreatedObjectStats) > 0 {
		for _, b := range m.CreatedObjectStats {
			l = len(b)
			n += 1 + l + sovApi(uint64(l))
		}
	}
	if len(m.TransferBookingLocations) > 0 {
		for _, s := range m.TransferBookingLocations {
			l = len(s)
			n += 2 + l + sovApi(uint64(l))
		}
	}
	l = len(m.TransferMappingDigest)
	if l > 0 {
		n += 2 + l + sovApi(uint64(l))
	}
	if m.FinalPrepareDeadlineUnixNano != 0 {
		n += 2 + sovApi(uint64(m.FinalPrepareDeadlineUnixNano))
	}
	if m.MaxDeltaRows != 0 {
		n += 2 + sovApi(uint64(m.MaxDeltaRows))
	}
	if m.MaxDeltaBytes != 0 {
		n += 2 + sovApi(uint64(m.MaxDeltaBytes))
	}
	if m.MaxDeltaBlocks != 0 {
		n += 2 + sovApi(uint64(m.MaxDeltaBlocks))
	}
	if m.MergeLevel != 0 {
		n += 2 + sovApi(uint64(m.MergeLevel))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *Entry) ProtoSize() (n int) {
	...
	if m.AutoIncrEpoch != 0 {
		n += 1 + sovApi(uint64(m.AutoIncrEpoch))
	}
	if m.AutoIncrEpochKnown {
		n += 2
	}
	if m.LifecycleCommit != nil {
		l = m.LifecycleCommit.ProtoSize()
		n += 1 + l + sovApi(uint64(l))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
...
func (m *AlterTableReq_ReplaceDef) ProtoSize() (n int) {
	...
	_ = l
	if m.ReplaceDef != nil {
		l = m.ReplaceDef.ProtoSize()
		n += 1 + l + sovApi(uint64(l))
	}
	return n
}
func (m *AlterTableReq_UpdateAutoIncrement) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.UpdateAutoIncrement != nil {
		l = m.UpdateAutoIncrement.ProtoSize()
		n += 1 + l + sovApi(uint64(l))
	}
	return n
}
func (m *SchemaExtra) ProtoSize() (n int) {
	...
	if m.FeatureFlag != 0 {
		n += 1 + sovApi(uint64(m.FeatureFlag))
	}
	if len(m.IndexTables) > 0 {
		l = 0
	...
	if m.ParentTableID != 0 {
		n += 1 + sovApi(uint64(m.ParentTableID))
	}
	if m.FromPublication {
		n += 2
	}
	if m.AutoIncrOffset != 0 {
		n += 2 + sovApi(uint64(m.AutoIncrOffset))
	}
	if m.AutoIncrEpoch != 0 {
		n += 2 + sovApi(uint64(m.AutoIncrEpoch))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *PrecommitWriteCmd) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SyncProtectionJobId", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SyncProtectionJobId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipApi(dAtA[iNdEx:])
...
func (m *LifecycleCommitEntry) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LifecycleCommitEntry: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LifecycleCommitEntry: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RetireMode", wireType)
			}
			m.RetireMode = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RetireMode |= LifecycleCommitEntry_RetireMode(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 8:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LogicalTableId |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 9:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PhysicalTableId |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BindingGeneration", wireType)
			}
			m.BindingGeneration = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowApi
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BindingGeneration |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SchemaDigest", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SchemaDigest = append(m.SchemaDigest[:0], dAtA[iNdEx:postIndex]...)
			if m.SchemaDigest == nil {
				m.SchemaDigest = []byte{}
			}
			iNdEx = postIndex
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SourceSnapshotTs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SourceSnapshotTs == nil {
				m.SourceSnapshotTs = &timestamp.Timestamp{}
			}
			if err := m.SourceSnapshotTs.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SourceSetDigest", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SourceSetDigest = append(m.SourceSetDigest[:0], dAtA[iNdEx:postIndex]...)
			if m.SourceSetDigest == nil {
				m.SourceSetDigest = []byte{}
			}
			iNdEx = postIndex
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DataSourceObjectStats", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DataSourceObjectStats = append(m.DataSourceObjectStats, make([]byte, postIndex-iNdEx))
			copy(m.DataSourceObjectStats[len(m.DataSourceObjectStats)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CreatedObjectStats", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CreatedObjectStats = append(m.CreatedObjectStats, make([]byte, postIndex-iNdEx))
			copy(m.CreatedObjectStats[len(m.CreatedObjectStats)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 16:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TransferBookingLocations", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TransferBookingLocations = append(m.TransferBookingLocations, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 17:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TransferMappingDigest", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TransferMappingDigest = append(m.TransferMappingDigest[:0], dAtA[iNdEx:postIndex]...)
			if m.TransferMappingDigest == nil {
				m.TransferMappingDigest = []byte{}
			}
			iNdEx = postIndex
		case 18:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FinalPrepareDeadlineUnixNano", wireType)
			}
			m.FinalPrepareDeadlineUnixNano = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowApi
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FinalPrepareDeadlineUnixNano |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 19:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxDeltaRows", wireType)
			}
			m.MaxDeltaRows = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxDeltaRows |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 20:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxDeltaBytes", wireType)
			}
			m.MaxDeltaBytes = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxDeltaBytes |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 21:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxDeltaBlocks", wireType)
			}
			m.MaxDeltaBlocks = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxDeltaBlocks |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 22:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MergeLevel", wireType)
			}
			m.MergeLevel = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MergeLevel |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Entry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AutoIncrEpochKnown", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AutoIncrEpochKnown = bool(v != 0)
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LifecycleCommit", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.LifecycleCommit == nil {
				m.LifecycleCommit = &LifecycleCommitEntry{}
			}
			if err := m.LifecycleCommit.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *AlterTableReplaceDef) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AlterTableReplaceDef: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AlterTableReplaceDef: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *AlterTableReq) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReplaceDef", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &AlterTableReplaceDef{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Operation = &AlterTableReq_ReplaceDef{v}
			iNdEx = postIndex
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UpdateAutoIncrement", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Operation = &AlterTableReq_UpdateAutoIncrement{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipApi(dAtA[iNdEx:])
	...
	for iNdEx < l {
		...
		case 12:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FeatureFlag |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 13:
			if wireType == 0 {
				...
				m.IndexTables = append(m.IndexTables, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.IndexTables) == 0 {
					m.IndexTables = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
		...
		case 14:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ParentTableID", wireType)
			}
			m.ParentTableID = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ParentTableID |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 15:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FromPublication", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
