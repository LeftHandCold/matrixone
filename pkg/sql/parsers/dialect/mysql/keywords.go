...
func init() {
	keywords = map[string]int{
		...
		"geometry32":                 GEOMETRY32,
		"geometrycollection32":       GEOMETRYCOLLECTION32,
		"geography":                  GEOGRAPHY,
		"geography32":                GEOGRAPHY32,
		"point32":                    POINT32,
		"linestring32":               LINESTRING32,
		"polygon32":                  POLYGON32,
		"multipoint32":               MULTIPOINT32,
		"multilinestring32":          MULTILINESTRING32,
		"multipolygon32":             MULTIPOLYGON32,
		"get":                        UNUSED,
